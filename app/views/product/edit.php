...
<body>
  ...
  <h3 class="text-center p-3  bg-primary text-white">Add Products</h3>
       ...
       <div class="form-group">
            ...
            <input type="text" name="Price" class="form-control" value="<?php echo $key['Price']?>">
         </div><div class="form-group">
            <label for="Discription" >Discription</label>
            <input type="text" name="Discription" class="form-control"value="<?php echo $key['Discription']?>">
         </div>
         <div class="form-group">
            <label for="Quantite" >Quantite</label>
            <input type="text" name="Quantite" class="form-control"value="<?php echo $key['Quantite']?>">
         </div>
